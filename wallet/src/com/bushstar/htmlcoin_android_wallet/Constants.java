...
package com.bushstar.htmlcoin_android_wallet;
...
public class Constants
{
	...
	public static final String EXTERNAL_WALLET_KEY_BACKUP = "htmlcoin-wallet-keys";
	public static final String EXTERNAL_WALLET_BACKUP = "htmlcoin-wallet-backup";
	...
	public static final String EXPLORE_BASE_URL = "http://explorer.htmlcoin.com/";

	public static final String MIMETYPE_TRANSACTION = "application/x-html5tx";
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-htmlcoin-wallet-backup";

	public static final int MAX_NUM_CONFIRMATIONS = 7;
	public static final String USER_AGENT = "HTMLcoin Wallet";
	...
	public static final String CURRENCY_CODE_HTML5 = "HTML";
	public static final String CURRENCY_CODE_MHTML5 = "mHTML";
	public static final String CURRENCY_CODE_UHTML5 = "µHTML";
	...
	public static final String DONATION_ADDRESS = "HDevhfXNpTk4AziXru7TC4DAASveZTMH5w";
	public static final String REPORT_EMAIL = "sr.machado@gmail.com";
	public static final String REPORT_SUBJECT_ISSUE = "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/machado-rev/htmlcoin-android-wallet";
	public static final String BINARY_URL = "https://github.com/machado-rev/htmlcoin-android-wallet/releases";
	public static final String CREDITS_HTMLCOINJ_URL = "https://github.com/machado-rev/htmlcoinj";
