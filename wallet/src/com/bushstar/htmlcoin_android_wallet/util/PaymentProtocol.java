...
package com.bushstar.htmlcoin_android_wallet.util;
...
import com.bushstar.htmlcoinj.core.ScriptException;
import com.bushstar.htmlcoinj.core.Transaction;
import com.bushstar.htmlcoinj.protocols.payments.PaymentRequestException;
import com.bushstar.htmlcoinj.protocols.payments.PaymentSession;
import com.bushstar.htmlcoinj.protocols.payments.PaymentSession.PkiVerificationData;
...
{
	public static final String MIMETYPE_PAYMENTREQUEST = "application/htmlcoin-paymentrequest"; // BIP 71
	public static final String MIMETYPE_PAYMENT = "application/htmlcoin-payment"; // BIP 71
	public static final String MIMETYPE_PAYMENTACK = "application/htmlcoin-paymentack"; // BIP 71
			...
			@Nullable final BigInteger refundAmount, @Nullable final String memo, @Nullable final byte[] merchantData)
	{
		...
		builder.addTransactions(ByteString.copyFrom(transaction.unsafeHTMLcoinSerialize()));
