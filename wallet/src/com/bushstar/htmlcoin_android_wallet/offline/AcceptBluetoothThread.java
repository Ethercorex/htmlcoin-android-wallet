...
package com.bushstar.htmlcoin_android_wallet.offline;
...
import org.htmlcoin.protocols.payments.Protos.PaymentACK;
...
public abstract class AcceptBluetoothThread extends Thread
{
	...
	protected static BluetoothServerSocket listen(final BluetoothAdapter adapter, final UUID uuid)
	{
		try
		{
			return adapter.listenUsingInsecureRfcommWithServiceRecord("HTMLcoin Transaction Submission", uuid);
		}
		catch (final IOException x)
		{
