...
import org.htmlcoin.protocols.payments.Protos.Payment;
...
import com.bushstar.htmlcoinj.core.Wallet.SendRequest;

import com.bushstar.htmlcoin_android_wallet.AddressBookProvider;
import com.bushstar.htmlcoin_android_wallet.Configuration;
import com.bushstar.htmlcoin_android_wallet.Constants;
import com.bushstar.htmlcoin_android_wallet.ExchangeRatesProvider;
import com.bushstar.htmlcoin_android_wallet.ExchangeRatesProvider.ExchangeRate;
import com.bushstar.htmlcoin_android_wallet.WalletApplication;
import com.bushstar.htmlcoin_android_wallet.data.PaymentIntent;
import com.bushstar.htmlcoin_android_wallet.data.PaymentIntent.Standard;
import com.bushstar.htmlcoin_android_wallet.integration.android.HTMLcoinIntegration;
import com.bushstar.htmlcoin_android_wallet.offline.DirectPaymentTask;
import com.bushstar.htmlcoin_android_wallet.ui.InputParser.BinaryInputParser;
import com.bushstar.htmlcoin_android_wallet.ui.InputParser.StreamInputParser;
import com.bushstar.htmlcoin_android_wallet.ui.InputParser.StringInputParser;
import com.bushstar.htmlcoin_android_wallet.util.Bluetooth;
import com.bushstar.htmlcoin_android_wallet.util.GenericUtils;
import com.bushstar.htmlcoin_android_wallet.util.Nfc;
import com.bushstar.htmlcoin_android_wallet.util.PaymentProtocol;
import com.bushstar.htmlcoin_android_wallet.util.WalletUtils;
...
public final class SendCoinsFragment extends SherlockFragment
{
	...
	private void initStateFromHTMLcoinUri(@Nonnull final Uri htmlcoinUri)
	{
		final String input = htmlcoinUri.toString();
	...
	private void initStateFromIntentUri(@Nonnull final String mimeType, @Nonnull final Uri htmlcoinUri)
	{
		try
		{
			final InputStream is = contentResolver.openInputStream(htmlcoinUri);
