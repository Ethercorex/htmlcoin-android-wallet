...
public final class WalletAddressFragment extends Fragment
{
	...
	private View htmlcoinAddressButton;
	private TextView htmlcoinAddressLabel;
	private ImageView htmlcoinAddressQrView;
	...
	public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState)
	{
		...
		htmlcoinAddressButton = view.findViewById(R.id.htmlcoin_address_button);
		htmlcoinAddressLabel = (TextView) view.findViewById(R.id.htmlcoin_address_label);
		htmlcoinAddressQrView = (ImageView) view.findViewById(R.id.htmlcoin_address_qr);

		htmlcoinAddressButton.setOnClickListener(new OnClickListener()
		{
			@Override
		...
		htmlcoinAddressQrView.setOnClickListener(new OnClickListener()
		{
			@Override
			public void onClick(final View v)
			{
	...
	private void updateView()
	{
		...
		if (!selectedAddress.equals(lastSelectedAddress))
		{
			...
			htmlcoinAddressLabel.setText(WalletUtils.formatAddress(selectedAddress, Constants.ADDRESS_FORMAT_GROUP_SIZE,
					Constants.ADDRESS_FORMAT_LINE_SIZE));

			final String addressStr = HTMLcoinURI.convertToHTMLcoinURI(selectedAddress, null, null, null);

			final int size = (int) (256 * getResources().getDisplayMetrics().density);
			qrCodeBitmap = Qr.bitmap(addressStr, size);
			htmlcoinAddressQrView.setImageBitmap(qrCodeBitmap);
