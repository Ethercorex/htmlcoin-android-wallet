...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_HTMLCOINJ = "about_credits_htmlcoinj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_HTMLCOINJ).setTitle(getString(R.string.about_credits_htmlcoinj_title, VersionMessage.HTMLcoinJ_VERSION));
		findPreference(KEY_ABOUT_CREDITS_HTMLCOINJ).setSummary(Constants.CREDITS_HTMLCOINJ_URL);
	...
	public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen, final Preference preference)
	{
		...
		else if (KEY_ABOUT_CREDITS_HTMLCOINJ.equals(key))
		{
			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.CREDITS_HTMLCOINJ_URL)));
			finish();
		}
