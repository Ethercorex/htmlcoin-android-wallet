...
package com.bushstar.htmlcoin_android_wallet.data;
...
import com.bushstar.htmlcoinj.core.WrongNetworkException;
...
public final class PaymentIntent implements Parcelable
{
	...
	public static PaymentIntent fromHTMLcoinUri(@Nonnull final HTMLcoinURI htmlcoinUri)
	{
		final Output[] outputs = buildSimplePayTo(htmlcoinUri.getAmount(), htmlcoinUri.getAddress());
		final String bluetoothMac = (String) htmlcoinUri.getParameterByName(Bluetooth.MAC_URI_PARAM);

		return new PaymentIntent(PaymentIntent.Standard.BIP21, null, null, null, outputs, htmlcoinUri.getLabel(), bluetoothMac != null ? "bt:"
				+ bluetoothMac : null, null, htmlcoinUri.getPaymentRequestUrl());
	}
